...
- [ ] Added two pie charts to R code. Maybe still one showing percentage of reads for each number of hits. Improve coloring
- [X] Fix file naming and fix writing the data to a file. the csv file seems to be bugged a bit. FIXED.
