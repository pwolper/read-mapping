...
p4 <- ggplot(pie2, aes(x="", y=value, fill=Group)) +
  ...
  labs(caption = "Fig 4: Number of reads mapped to sense strand, anti-sense strand, both strands or none in Genome.")
...
ggsave("F5_Reads_by_number_of_hits.tiff",p5 ,device = "tiff", dpi = 300, path = output)
```
