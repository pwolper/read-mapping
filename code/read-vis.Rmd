...
p2p3 <- ggpubr::ggarrange(p2,p3,nrow = 1, widths = c(1,1), heights = c(0.5,2), align = "h") + coord_equal()
p2p3

ggsave("F2_and_F3_orient.png", p2p3, device = "png",width = 30, dpi = 300, path = here("doc/")) 
```

```{R echo = FALSE, fig_width = 50}
p3
p4
p5
```
