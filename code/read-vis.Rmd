...
p2p3 <- ggpubr::ggarrange(p2,p3,nrow = 1, widths = c(1,0.5), align = "h") +coord_fixed()
p2p3

p1p4 <- ggpubr::ggarrange(p1,p4, nrow = 1, widths = c(1,0.6),heights = c(1,1.5), align = "v", common.legend = TRUE)
p1p4
