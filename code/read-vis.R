...
##Genome Input
if(exists("inputGenome")){
}else{
inputGenome <- here("data/Ecoli_genome.fasta")
}
...
p1p4 <- ggpubr::ggarrange(p1,p4, nrow = 1, widths = c(1,1),heights = c(1,10),
